...
public class LoanCalculatorPage extends BaseClass{
	...
	public void validateCalHomePage() throws HeadlessException, AWTException, IOException
	{
		String title=null;
	...
	public int GetEMIWithDefferData(int testCaseID) throws HeadlessException, AWTException, IOException//ID is defined in ./TestData/TestData.xlsx
	{
		try 
		{
			String title=null;
			...
			interestRate.sendKeys(Keys.HOME,Keys.chord(Keys.SHIFT,Keys.END),excel.getData("EMIDATA", testCaseID, 3));
